...
void c_reflectionfunctionabstract::o_get(Array &props) const {
  if (isInitialized(m_info)) props.set("info", m_info.isReferenced() ? ref(m_info) : m_info);
...
/* SRC: classes/reflection.php line 503 */
...
c_reflectionobject *c_reflectionobject::create(Variant v_obj) {
  incRefCount();
  init();
  t___construct(v_obj);
  decRefCount();
...
ObjectData *c_reflectionobject::dynCreate(CArrRef params, bool construct /* = true */) {
  init();
  if (construct) {
    incRefCount();
    int count = params.size();
    if (count < 1) throw_missing_argument("reflectionobject::__construct", count+1);
...
void c_reflectionobject::dynConstructFromEval(Eval::VariableEnvironment &env, const Eval::FunctionCallExpression *caller) {
  Variant a0;
  const std::vector<Eval::ExpressionPtr> &params = caller->params();
  std::vector<Eval::ExpressionPtr>::const_iterator it = params.begin();
  do {
...
/* SRC: classes/reflection.php line 504 */
...
void c_reflectionclass::o_get(Array &props) const {
  if (isInitialized(m_name)) props.set("name", m_name.isReferenced() ? ref(m_name) : m_name);
  if (isInitialized(m_info)) props.set("info", m_info.isReferenced() ? ref(m_info) : m_info);
  c_ObjectData::o_get(props);
}
...
void c_reflectionclass::t___construct(Variant v_name) {
  ...
  if (x_is_object(v_name)) {
    ...
    {
      x_call_user_func(2, "class_exists", Array(ArrayInit(1, true).set(0, v_name).create()));
    }
  }
  (m_info = x_call_user_func(2, "hphp_get_class_info", Array(ArrayInit(1, true).set(0, v_name).create())));
  if (empty(m_info)) {
    {
      {
  ...
  (m_name = m_info.rvalAt("name", 0x0BCDB293DC3CBDDCLL, true, true));
  {
    LOOP_COUNTER(9);
    Variant map10 = m_info.rvalAt("interfaces", 0x0C5BD661CFB8E254LL, true, true);
    for (ArrayIterPtr iter11 = map10.begin("reflectionclass"); !iter11->end(); iter11->next()) {
      ...
      {
        {
          c_reflectionclass *tmp12 = NEWOBJ(c_reflectionclass)();
          (v_p = p_reflectionclass(tmp12->create(v_interface)));
        }
    ...
    {
      {
        ...
        (v_p = p_reflectionclass(tmp13->create(m_info.rvalAt("parent", 0x16E2F26FFB10FD8CLL, true, true))));
      }
      lval(m_info.lvalAt("interfaces", 0x0C5BD661CFB8E254LL, false, true)) += AS_CLASS(v_p,c_reflectionclass)->m_info.rvalAt("interfaces", 0x0C5BD661CFB8E254LL, true, true);
...
/* SRC: classes/reflection.php line 241 */
Variant c_reflectionclass::ti_export(const char* cls, CVarRef v_name, CVarRef v_ret) {
...

  {
    ...
    (v_obj = p_reflectionclass(tmp14->create(v_name)));
  }
  (v_str = (toString(v_obj)));
  if (toBoolean(v_ret)) {
    {
...
bool c_reflectionclass::t_isinstantiable() {
  ...
  return !(toBoolean(m_info.rvalAt("abstract", 0x475C06CE12C8A8A6LL, true, true)));
} /* function */
...
bool c_reflectionclass::t_hasconstant(CVarRef v_name) {
  ...
  return isset(m_info.rvalAt("constants", 0x3A127EB7623AE369LL, false, true), v_name);
} /* function */
...
bool c_reflectionclass::t_hasmethod(CVarRef v_name) {
  ...
  return isset(m_info.rvalAt("methods", 0x2A7E90235B229AD5LL, false, true), x_strtolower(toString(v_name)));
} /* function */
...
bool c_reflectionclass::t_hasproperty(CVarRef v_name) {
  ...
  return isset(m_info.rvalAt("properties", 0x5D7B5CC390269404LL, false, true), v_name);
} /* function */
...
Variant c_reflectionclass::t_getconstructor() {
  ...
  if (t_hasmethod(m_info.rvalAt("name", 0x0BCDB293DC3CBDDCLL, true, true))) {
    {
      return t_getmethod(m_info.rvalAt("name", 0x0BCDB293DC3CBDDCLL, true, true));
    }
  }
  return null;
} /* function */
/* SRC: classes/reflection.php line 304 */
p_reflectionmethod c_reflectionclass::t_getmethod(CVarRef v_name) {
  ...
  if (!(isset(m_info.rvalAt("methods", 0x2A7E90235B229AD5LL, false, true), v_lname))) {
    {
      (v_class = m_info.rvalAt("name", 0x0BCDB293DC3CBDDCLL, true, true));
      {
        c_reflectionexception *tmp15 = NEWOBJ(c_reflectionexception)();
        throw_exception(p_reflectionexception(tmp15->create(concat5("Method ", toString(v_class), "::", toString(v_name), " does not exist"))));
      }
    }
  }
  (v_ret = p_reflectionmethod((NEWOBJ(c_reflectionmethod)())->create(null, null)));
  (AS_CLASS(v_ret,c_reflectionmethod)->m_info = m_info.rvalAt("methods", 0x2A7E90235B229AD5LL, true, true).rvalAt(v_lname, -1, true));
...
Array c_reflectionclass::t_getmethods(int64 v_filter //  = 65535LL
  ...
  {
    LOOP_COUNTER(16);
    Variant map17 = m_info.rvalAt("methods", 0x2A7E90235B229AD5LL, true, true);
...
/* SRC: classes/reflection.php line 334 */
p_reflectionproperty c_reflectionclass::t_getproperty(CVarRef v_name) {
  ...
  if (!(isset(m_info.rvalAt("properties", 0x5D7B5CC390269404LL, false, true), v_name))) {
    {
      (v_class = m_info.rvalAt("name", 0x0BCDB293DC3CBDDCLL, true, true));
      {
        c_reflectionexception *tmp19 = NEWOBJ(c_reflectionexception)();
        throw_exception(p_reflectionexception(tmp19->create(concat5("Property ", toString(v_class), "::", toString(v_name), " does not exist"))));
      }
    }
  }
  (v_ret = p_reflectionproperty((NEWOBJ(c_reflectionproperty)())->create(null, null)));
  (AS_CLASS(v_ret,c_reflectionproperty)->m_info = m_info.rvalAt("properties", 0x5D7B5CC390269404LL, true, true).rvalAt(v_name, -1, true));
...
Array c_reflectionclass::t_getproperties() {
  ...
  {
    LOOP_COUNTER(20);
    Variant map21 = m_info.rvalAt("properties", 0x5D7B5CC390269404LL, true, true);
    for (ArrayIterPtr iter22 = map21.begin("reflectionclass"); !iter22->end(); iter22->next()) {
...
/* SRC: classes/reflection.php line 355 */
...
Variant c_reflectionclass::t_getconstant(CVarRef v_name) {
  ...
  if (!(isset(m_info.rvalAt("constants", 0x3A127EB7623AE369LL, false, true), v_name))) {
    {
      (v_class = m_info.rvalAt("name", 0x0BCDB293DC3CBDDCLL, true, true));
      {
        c_reflectionexception *tmp23 = NEWOBJ(c_reflectionexception)();
        throw_exception(p_reflectionexception(tmp23->create(concat5("Class constant ", toString(v_class), "::", toString(v_name), " does not exist"))));
      }
    }
  }
  return m_info.rvalAt("constants", 0x3A127EB7623AE369LL, true, true).rvalAt(v_name, -1, true);
} /* function */
...
Variant c_reflectionclass::t_getinterfaces() {
  ...
  {
    LOOP_COUNTER(24);
    Variant map25 = m_info.rvalAt("interfaces", 0x0C5BD661CFB8E254LL, true, true);
    for (ArrayIterPtr iter26 = map25.begin("reflectionclass"); !iter26->end(); iter26->next()) {
      ...
      {
        {
          ...
          (v_cls = p_reflectionclass(tmp27->create(v_name)));
        }
        if (toBoolean(AS_CLASS(v_cls,c_reflectionclass)->t_isinterface())) {
          {
            v_ret.set(v_name, (v_cls));
          }
        }
      }
    }
...
Array c_reflectionclass::t_getinterfacenames() {
  ...
  {
    LOOP_COUNTER(28);
    Variant map29 = m_info.rvalAt("interfaces", 0x0C5BD661CFB8E254LL, true, true);
    for (ArrayIterPtr iter30 = map29.begin("reflectionclass"); !iter30->end(); iter30->next()) {
      ...
      {
        {
          c_reflectionclass *tmp31 = NEWOBJ(c_reflectionclass)();
          (v_cls = p_reflectionclass(tmp31->create(v_name)));
        }
        if (toBoolean(AS_CLASS(v_cls,c_reflectionclass)->t_isinterface())) {
          {
...
/* SRC: classes/reflection.php line 389 */
Variant c_reflectionclass::t_isinterface() {
  INSTANCE_METHOD_INJECTION(ReflectionClass, ReflectionClass::isInterface);
  return m_info.rvalAt("interface", 0x448B10707228E959LL, true, true);
} /* function */
/* SRC: classes/reflection.php line 393 */
...
/* SRC: classes/reflection.php line 401 */
...
/* SRC: classes/reflection.php line 405 */
bool c_reflectionclass::t_isinstance(CVarRef v_obj) {
  INSTANCE_METHOD_INJECTION(ReflectionClass, ReflectionClass::isInstance);
  return x_hphp_instanceof(toObject(v_obj), toString(m_info.rvalAt("name", 0x0BCDB293DC3CBDDCLL, true, true)));
} /* function */
/* SRC: classes/reflection.php line 409 */
Object c_reflectionclass::t_newinstance(int num_args, Array args /* = Array() */) {
  ...
  return x_hphp_create_object(toString(m_info.rvalAt("name", 0x0BCDB293DC3CBDDCLL, true, true)), v_args);
} /* function */
...
Object c_reflectionclass::t_newinstanceargs(CVarRef v_args) {
  ...
  return x_hphp_create_object(toString(m_info.rvalAt("name", 0x0BCDB293DC3CBDDCLL, true, true)), toArray(v_args));
} /* function */
...
Variant c_reflectionclass::t_getparentclass() {
  ...
  {
    c_reflectionclass *tmp32 = NEWOBJ(c_reflectionclass)();
    return p_reflectionclass(tmp32->create(m_info.rvalAt("parent", 0x16E2F26FFB10FD8CLL, true, true)));
  }
} /* function */
/* SRC: classes/reflection.php line 425 */
Variant c_reflectionclass::t_issubclassof(Variant v_cls) {
  ...
  if (instanceOf(v_cls, "ReflectionClass")) {
    {
      (v_cls = v_cls.o_get("info", 0x59E9384E33988B3ELL).rvalAt("name", 0x0BCDB293DC3CBDDCLL, true, true));
    }
  }
  {
    LOOP_COUNTER(33);
    Variant map34 = m_info.rvalAt("interfaces", 0x0C5BD661CFB8E254LL, true, true);
    for (ArrayIterPtr iter35 = map34.begin("reflectionclass"); !iter35->end(); iter35->next()) {
  ...
  if (equal(x_strcasecmp(toString(v_cls), toString(m_info.rvalAt("parent", 0x16E2F26FFB10FD8CLL, true, true))), 0LL)) {
    {
      return true;
    }
  }
  {
    Object tmp36((toObject(t_getparentclass())));
    return tmp36->o_invoke_few_args("isSubclassOf", 0x373333991926C97ELL, 1, v_cls);
  }
} /* function */
...
Variant c_reflectionclass::t_getstaticproperties() {
  ...
  {
    LOOP_COUNTER(37);
    Variant map38 = t_getproperties();
    for (ArrayIterPtr iter39 = map38.begin("reflectionclass"); !iter39->end(); iter39->next()) {
      LOOP_COUNTER_CHECK(37);
      iter39->second(v_prop);
      {
...
/* SRC: classes/reflection.php line 453 */
Variant c_reflectionclass::t_getstaticpropertyvalue(CVarRef v_name, CVarRef v_default //  = null_variant
  ...
  if (t_hasproperty(v_name) && toBoolean(AS_CLASS(t_getproperty(v_name),c_reflectionproperty)->t_isstatic())) {
    {
      return x_hphp_get_static_property(toString(m_info.rvalAt("name", 0x0BCDB293DC3CBDDCLL, true, true)), toString(v_name));
    }
  }
  return v_default;
} /* function */
...
void c_reflectionclass::t_setstaticpropertyvalue(CVarRef v_name, CVarRef v_value) {
  ...
  x_hphp_set_static_property(toString(m_info.rvalAt("name", 0x0BCDB293DC3CBDDCLL, true, true)), toString(v_name), v_value);
} /* function */
...
/* SRC: classes/reflection.php line 475 */
...
bool c_reflectionclass::t_implementsinterface(Variant v_cls) {
  ...
  {
    LOOP_COUNTER(43);
    Variant map44 = m_info.rvalAt("interfaces", 0x0C5BD661CFB8E254LL, true, true);
    for (ArrayIterPtr iter45 = map44.begin("reflectionclass"); !iter45->end(); iter45->next()) {
...
Variant c_reflectionclass::t_getextensionname() {
  ...
  return m_info.rvalAt("extension", 0x3E8C2484E9BF4500LL, true, true).o_invoke_few_args("getName", 0x23F51CDECC198965LL, 0);
} /* function */
...
void c_reflectionextension::o_get(Array &props) const {
  if (isInitialized(m_name)) props.set(String("\0reflectionextension\0name", 25, CopyString), m_name.isReferenced() ? ref(m_name) : m_name);
  if (isInitialized(m_info)) props.set(String("\0reflectionextension\0info", 25, CopyString), m_info.isReferenced() ? ref(m_info) : m_info);
  c_ObjectData::o_get(props);
}
...
/* SRC: classes/reflection.php line 727 */
...
/* SRC: classes/reflection.php line 731 */
...
Variant c_reflectionextension::ti_export(const char* cls, CVarRef v_name, CVarRef v_ret) {
  ...
  {
    c_reflectionextension *tmp46 = NEWOBJ(c_reflectionextension)();
    (v_obj = p_reflectionextension(tmp46->create(v_name)));
  }
  (v_str = (toString(v_obj)));
  if (toBoolean(v_ret)) {
    {
...
/* SRC: classes/reflection.php line 759 */
...
Array c_reflectionextension::t_getclassnames() {
  ...
  {
    LOOP_COUNTER(47);
    Variant map48 = m_info.rvalAt("classes", 0x475D2D970415E4A0LL, true, true);
    for (ArrayIterPtr iter49 = map48.begin("reflectionextension"); !iter49->end(); iter49->next()) {
...
/* SRC: classes/reflection.php line 622 */
...
void c_reflectionmethod::o_get(Array &props) const {
  if (isInitialized(m_name)) props.set("name", m_name.isReferenced() ? ref(m_name) : m_name);
  if (isInitialized(m_class)) props.set("class", m_class.isReferenced() ? ref(m_class) : m_class);
  ...
  if (toBoolean(v_cls) && toBoolean(v_name)) {
    {
      if (!(x_is_object(v_cls))) {
        {
          c_reflectionclass *tmp50 = NEWOBJ(c_reflectionclass)();
          (v_cls = p_reflectionclass(tmp50->create(v_cls)));
        }
      }
...
/* SRC: classes/reflection.php line 646 */
...
Variant c_reflectionmethod::ti_export(const char* cls, Variant v_cls, CVarRef v_name, CVarRef v_ret) {
  ...
  if (!(x_is_object(v_cls))) {
    {
      c_reflectionclass *tmp51 = NEWOBJ(c_reflectionclass)();
      (v_cls = p_reflectionclass(tmp51->create(v_cls)));
    }
  }
...
Variant c_reflectionmethod::t_invokeargs(CVarRef v_obj, CVarRef v_args) {
  ...
  {
    Variant tmp52((v_obj));
    String tmp53((toString(m_info.rvalAt("class", 0x45397FE5C82DBD12LL, true, true))));
    String tmp54((toString(m_info.rvalAt("name", 0x0BCDB293DC3CBDDCLL, true, true))));
    return x_hphp_invoke_method(tmp52, tmp53, tmp54, toArray(x_array_values(v_args)));
  }
} /* function */
/* SRC: classes/reflection.php line 672 */
...
/* SRC: classes/reflection.php line 688 */
...
/* SRC: classes/reflection.php line 692 */
...
Variant c_reflectionmethod::t_getdeclaringclass() {
  ...
  }
  {
    ...
    return p_reflectionclass(tmp55->create(m_info.rvalAt("class", 0x45397FE5C82DBD12LL, true, true)));
  }
} /* function */
...
/* SRC: classes/reflection.php line 531 */
...
/* SRC: classes/reflection.php line 543 */
...
Variant c_reflectionproperty::ti_export(const char* cls, Variant v_cls, CVarRef v_name, CVarRef v_ret) {
  ...
  if (!(x_is_object(v_cls))) {
    {
      c_reflectionclass *tmp57 = NEWOBJ(c_reflectionclass)();
      (v_cls = p_reflectionclass(tmp57->create(v_cls)));
    }
  }
...
/* SRC: classes/reflection.php line 572 */
...
/* SRC: classes/reflection.php line 583 */
...
/* SRC: classes/reflection.php line 607 */
Variant c_reflectionproperty::t_getdeclaringclass() {
  ...
  }
  {
    ...
    return p_reflectionclass(tmp58->create(m_info.rvalAt("class", 0x45397FE5C82DBD12LL, true, true)));
  }
} /* function */
/* SRC: classes/reflection.php line 614 */
...
void c_reflectionfunction::t___construct(Variant v_name) {
  ...
  if (empty(m_info)) {
    {
      {
        c_reflectionexception *tmp59 = NEWOBJ(c_reflectionexception)();
        throw_exception(p_reflectionexception(tmp59->create(concat3("Function ", toString(v_name), " does not exist"))));
      }
    }
  }
  gasInCtor(oldInCtor);
...
Variant c_reflectionfunction::ti_export(const char* cls, CVarRef v_name, CVarRef v_ret) {
  ...
  {
    c_reflectionfunction *tmp60 = NEWOBJ(c_reflectionfunction)();
    (v_obj = p_reflectionfunction(tmp60->create(v_name)));
  }
  (v_str = (toString(v_obj)));
  if (toBoolean(v_ret)) {
    {
...
Variant c_reflectionfunction::t_invokeargs(CVarRef v_args) {
  ...
  {
    String tmp61((toString(m_info.rvalAt("name", 0x0BCDB293DC3CBDDCLL, true, true))));
    return x_hphp_invoke(tmp61, toArray(x_array_values(v_args)));
  }
} /* function */
...
Variant c_reflectionparameter::ti_export(const char* cls, CVarRef v_func, CVarRef v_param, CVarRef v_ret) {
  ...
  {
    c_reflectionparameter *tmp62 = NEWOBJ(c_reflectionparameter)();
    (v_obj = p_reflectionparameter(tmp62->create(v_func, v_param)));
  }
  (v_str = (toString(v_obj)));
  if (toBoolean(v_ret)) {
    {
...
Variant c_reflectionparameter::t_getclass() {
  ...
  }
  {
    ...
    return p_reflectionclass(tmp64->create(m_info.rvalAt("type", 0x508FC7C8724A760ALL, true, true)));
  }
} /* function */
