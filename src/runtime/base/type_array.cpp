...
const Variant Array::operator[](bool    key) const { return rvalAt(key);}
const Variant Array::operator[](char    key) const { return rvalAt(key);}
const Variant Array::operator[](short   key) const { return rvalAt(key);}
const Variant Array::operator[](int     key) const { return rvalAt(key);}
const Variant Array::operator[](int64   key) const { return rvalAt(key);}
const Variant Array::operator[](ssize_t key) const { return rvalAt(key);}
const Variant Array::operator[](double  key) const { return rvalAt(key);}
const Variant Array::operator[](litstr  key) const { return rvalAt(key);}
const Variant Array::operator[](CStrRef key) const { return rvalAt(key);}
const Variant Array::operator[](CVarRef key) const { return rvalAt(key);}
